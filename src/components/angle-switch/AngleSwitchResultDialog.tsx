 ...
 * Hộp thoại xem trước kết quả chuyển đổi góc nhìn
 */
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          <DialogTitle className="text-sm">Chuyển đổi góc nhìn - Chọn kết quả</DialogTitle>
          <DialogDescription className="sr-only">
            So sánh ảnh gốc và kết quả tạo ra, chọn và áp dụng góc nhìn mới
          </DialogDescription>
        </DialogHeader>
